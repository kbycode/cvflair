...
**Sekiz çerçeve biçimi, beş hazır tema — hepsi tek `Theme(...)` satırıyla.**
...
| [Örnek galerisi](https://github.com/kbycode/cvflair/blob/main/examples/README.md) | Dokuz çalışan örnek; hangisi kamera istiyor, hangisi istemiyor |
